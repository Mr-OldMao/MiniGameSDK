mergeInto(LibraryManager.library, {
  ...
  WX_ReportEvent: function (eventId, data) {
    window.WXWASMSDK.WX_ReportEvent(
      _WXPointer_stringify_adaptor(eventId),
      _WXPointer_stringify_adaptor(data)
    );
  },
  WX_ReportMonitor: function (name, value) {
    window.WXWASMSDK.WX_ReportMonitor(
      _WXPointer_stringify_adaptor(name),
      value
    );
  },
  WX_ReportPerformance: function (id, value, dimensions) {
    window.WXWASMSDK.WX_ReportPerformance(
      id,
      value,
      _WXPointer_stringify_adaptor(dimensions)
    );
  },
  WX_ReportUserBehaviorBranchAnalytics: function (option) {
    window.WXWASMSDK.WX_ReportUserBehaviorBranchAnalytics(
      _WXPointer_stringify_adaptor(option)
    );
  },
  WX_ReserveChannelsLive: function (option) {
    window.WXWASMSDK.WX_ReserveChannelsLive(
      _WXPointer_stringify_adaptor(option)
    );
  },
  ...
  WX_SetStorageSync: function (key, data) {
    window.WXWASMSDK.WX_SetStorageSync(
      _WXPointer_stringify_adaptor(key),
      _WXPointer_stringify_adaptor(data)
    );
  },
  ...
  WX_OnAddToFavorites_Resolve: function (conf) {
    window.WXWASMSDK.WX_OnAddToFavorites_Resolve(
      _WXPointer_stringify_adaptor(conf)
    );
  },
  ...
  WX_OnShareTimeline_Resolve: function (conf) {
    window.WXWASMSDK.WX_OnShareTimeline_Resolve(
      _WXPointer_stringify_adaptor(conf)
    );
  },
  ...
  WX_OnGameLiveStateChange_Resolve: function (conf) {
    window.WXWASMSDK.WX_OnGameLiveStateChange_Resolve(
      _WXPointer_stringify_adaptor(conf)
    );
  },

  WX_SetHandoffQuery: function (query) {
    var res = window.WXWASMSDK.WX_SetHandoffQuery(
      _WXPointer_stringify_adaptor(query)
    );
    return res;
  },
  ...
  WX_GetExptInfoSync: function (keys) {
    var res = window.WXWASMSDK.WX_GetExptInfoSync(
      _WXPointer_stringify_adaptor(keys)
    );
    var bufferSize = lengthBytesUTF8(res) + 1;
    var buffer = _malloc(bufferSize);
    stringToUTF8(res, buffer, bufferSize);
  ...
  WX_SetCursor: function (path, x, y) {
    var res = window.WXWASMSDK.WX_SetCursor(
      _WXPointer_stringify_adaptor(path),
      x,
      y
    );
    return res;
  },
  WX_SetMessageToFriendQuery: function (option) {
    var res = window.WXWASMSDK.WX_SetMessageToFriendQuery(
      _WXPointer_stringify_adaptor(option)
    );
    return res;
  },
  WX_GetTextLineHeight: function (option) {
    var res = window.WXWASMSDK.WX_GetTextLineHeight(
      _WXPointer_stringify_adaptor(option)
    );
    return res;
  },
  WX_LoadFont: function (path) {
  ...
  WX_NavigateToScene: function (conf, callbackId) {
    window.WXWASMSDK.WX_NavigateToScene(
      _WXPointer_stringify_adaptor(conf),
      _WXPointer_stringify_adaptor(callbackId)
    );
  },

  WX_CheckScene: function (conf, callbackId) {
    window.WXWASMSDK.WX_CheckScene(
      _WXPointer_stringify_adaptor(conf),
      _WXPointer_stringify_adaptor(callbackId)
    );
  },

  WX_AddShortcut: function (conf, callbackId) {
    window.WXWASMSDK.WX_AddShortcut(
      _WXPointer_stringify_adaptor(conf),
      _WXPointer_stringify_adaptor(callbackId)
    );
  },

  WX_CheckShortcut: function (conf, callbackId) {
    window.WXWASMSDK.WX_CheckShortcut(
      _WXPointer_stringify_adaptor(conf),
      _WXPointer_stringify_adaptor(callbackId)
    );
  },

  WX_RequestRecharge: function (conf, callbackId) {
    window.WXWASMSDK.WX_RequestRecharge(
      _WXPointer_stringify_adaptor(conf),
      _WXPointer_stringify_adaptor(callbackId)
    );
  },
  WX_SensitiveWordCheck: function (conf, callbackId) {
    window.WXWASMSDK.WX_SensitiveWordCheck(
      _WXPointer_stringify_adaptor(conf),
      _WXPointer_stringify_adaptor(callbackId)
    );
  },
